...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/seangillespie/oneirocom/magick/packages/server/db/src/lib/prisma/client-core",
      "fromEnvVar": null
    },
    "config": {
      "name": "prisma",
...
path.join(process.cwd(), "src/lib/prisma/client-core/libquery_engine-darwin.dylib.node")
...
path.join(process.cwd(), "src/lib/prisma/client-core/libquery_engine-linux-arm64-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
