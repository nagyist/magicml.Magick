...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/seangillespie/oneirocom/magick/portal/cloud/packages/db/src/lib/prisma/client-portal",
      "fromEnvVar": null
    },
    "config": {
      "name": "prisma",
  ...
  "inlineSchemaHash": "1c0991de434107cb7122cc024f9e5d1bd93395ffd4bd9f27e8a92e6a7630aa28",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/lib/prisma/client-portal/libquery_engine-darwin.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/lib/prisma/client-portal/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
