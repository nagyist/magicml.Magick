...
const AgentSettingsHeader = (props: Props) => {
  const [toggleAgentChat] = useAtom(toggleAgentChatAtom)
  ...
  return (
    <div className="hidden lg:flex justify-between">
      <div className="flex w-full flex-col flex-grow mb-4 md:items-center md:flex-row justify-evenly">
        <div className="flex lg:pt-2 items-center justify-evenly lg:justify-around">
          <svg
          ...
          >
            <path
              ...
              className="fill-current text-black dark:text-white color-transition"
            />
            <path
          ...
          <h1 className="ml-3 text-base md:text-2xl text-black dark:text-white font-montAlt color-transition">
            Agent Settings
          </h1>
        </div>
      </div>
      {toggleAgentChat && toggleAgentSettings && (
        <button
          onClick={() => setToggleAgentSettings(false)}
          type="button"
          className="flex items-center justify-center w-8 h-8 text-black transition-all bg-transparent rounded-full dark:text-white hover:text-secondary-light hover:bg-[#232323]"
        >
